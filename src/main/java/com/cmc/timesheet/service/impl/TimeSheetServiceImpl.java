...
//                                    convertStringToTime(timeSheetForm.getOverTimeHours(), TimeSheetConstant.TIME_FORMAT_REGEX))
    ...
    @Override
    public List<TimeSheetResponse> getTimeSheetDataForExcel(TimeSheetFilterRequest timeSheetFilterRequest) {
        return timeSheetRepository.getTimeSheetDataForExcel(timeSheetFilterRequest);
    }
    ...
    @Override
    public List<TimeSheetViewDetailResponse> getListTimeSheetExcelByEmployeeId(TimeSheetViewDetailRequest request) {
        return timeSheetRepository.getListTimeSheetExcelByUserId(request);
    }
